...
[要件・設計台帳](../design/requirements-and-design.md)が「何を満たすか」、
...
[専用 IP・BGP 経路設計](../design/egress-gateway-routed-design.md) を参照する。
...
- kind、Kubernetes、Cilium、Cilium CLI、Tetragonの採用versionは
  [参照URL台帳](../reference/references.md)のbaselineに従う。
