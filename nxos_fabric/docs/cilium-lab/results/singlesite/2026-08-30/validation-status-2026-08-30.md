...
詳細な測定値と合否条件は
[リソース設計と preflight](../../../runbooks/resource-and-preflight.md#6-2026-08-30-single-site-k02-初期構築結果)を参照する。
...
[Network Policy／Tetragon 検証計画](../../../tests/network-policy-and-tetragon-test-plan.md)、
